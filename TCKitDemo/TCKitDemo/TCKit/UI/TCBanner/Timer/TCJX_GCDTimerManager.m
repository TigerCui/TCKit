...
@interface TCJX_GCDTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@property (nonatomic, strong) NSTimer *timer;
@end

@implementation TCJX_GCDTimerManager

#pragma mark - Public Method

+ (TCJX_GCDTimerManager *)sharedInstance
{
    static TCJX_GCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[TCJX_GCDTimerManager alloc] init];
    });
